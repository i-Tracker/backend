...
private const val AIR_PODS_MAX = "AirPods Max"

@Component
class AirPodsMaxMapper : AirPodsMappingComponent {

    override fun supports(subCategory: String): Boolean {
        return AIR_PODS_MAX == subCategory
    }
    ...
    override fun toDomain(product: DefaultProduct): AirPods {
        ...
        val category = AirPodsCategory.AIRPODS_MAX
        val generation = "1"
        val canWirelessCharging = false
        val chargingType = "Lighting 8-pin"

        val colors = names[1].split(" ")
