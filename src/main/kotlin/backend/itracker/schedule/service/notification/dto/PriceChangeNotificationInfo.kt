...
data class PriceChangeNotificationInfo(
    ...
    val priceDropFromYesterday: BigDecimal,
    val discountRateDropFromYesterday: Int,
    ...
    fun mutableMap(): MutableMap<String, String> {
        return mutableMapOf(
            ...
            "#{price_drop_from_yesterday}" to toKrw(priceDropFromYesterday),
            "#{discount_rate_drop_from_yesterday}" to discountRateDropFromYesterday.absoluteValue.toString(),
